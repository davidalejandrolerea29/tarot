...
const CelticCrossReadingPage: React.FC = () => {
  ...
  useEffect(() => {
    const getCards = async () => {
      ...
      for (let i = 0; i < shuffled.length && uniqueCards.length < 10; i++) {
    ...
    <div className="max-w-7xl mx-auto px-4 py-12 text-white">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        {cards.map((card, index) => (
          ...
          >
            ...
            <img src={card.image} alt={card.name.es} className="mx-auto w-40 h-auto mb-4" />
            <h3 className="text-xl font-bold mb-2">
              {card.name[i18n.language as 'es' | 'en']}
            </h3>
      ...
      {cards.length === 10 && (
        ...
        >
          ...
          <div className="text-indigo-100 leading-relaxed text-sm md:text-base space-y-2">
...
export default CelticCrossReadingPage;
